...
; 以下は標準的なFA12フォーマットフロッピーディスクのための記述
	...
	DD  0          ; パーティションを使ていないので、ここはかならず0
	DD  2880       ; このドライブの大きさをもう一度書く
	DB  0, 0, 0x29 ; よくわからないけど、この値にしておくといいらしい
	DD  0xdddddddd ; 多分ボリュームシリアル番号
